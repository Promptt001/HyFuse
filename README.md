...
MCP server, embedding **81 tools** that let any AI agent sense, move, mine,
...
[![Tools](https://img.shields.io/badge/Tools-81-4dabf7)](docs/TOOL_CATALOG.md)
...
| Surface | A handful of ad-hoc endpoints | 81 typed MCP tools + an OpenAPI mirror |
...
<img src="docs/images/tool-map.webp" alt="The 81 tools grouped by category" width="720">
...
```bash
# MCP JSON-RPC: list all 81 tools
...
```bash
# Full OpenAPI 3.1 spec — 81 paths
...
> **OpenWebUI has been tested end-to-end with HyFuse** — 81 tools discovered,
...
## The tool surface — 81 tools at a glance
...
(81-tool registry pin, handler parity, slot maps, craft resolution, queue,
