...
MCP server, embedding **79 tools** that let any AI agent sense, move, mine,
...
[![Tools](https://img.shields.io/badge/Tools-79-4dabf7)](docs/TOOL_CATALOG.md)
...
| Surface | A handful of ad-hoc endpoints | 79 typed MCP tools + an OpenAPI mirror |
...
<img src="docs/images/tool-map.webp" alt="The 79 tools grouped by category" width="720">
...
```bash
# MCP JSON-RPC: list all 79 tools
...
```bash
# Full OpenAPI 3.1 spec — 79 paths
...
> **OpenWebUI has been tested end-to-end with HyFuse** — 79 tools discovered,
...
## The tool surface — 79 tools at a glance
...
(79-tool registry pin, handler parity, slot maps, craft resolution, queue,
