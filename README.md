...
MCP server, embedding **80 tools** that let any AI agent sense, move, mine,
...
[![Tools](https://img.shields.io/badge/Tools-80-4dabf7)](docs/TOOL_CATALOG.md)
...
| Surface | A handful of ad-hoc endpoints | 80 typed MCP tools + an OpenAPI mirror |
...
<img src="docs/images/tool-map.webp" alt="The 80 tools grouped by category" width="720">
...
```bash
# MCP JSON-RPC: list all 80 tools
...
```bash
# Full OpenAPI 3.1 spec — 80 paths
...
> **OpenWebUI has been tested end-to-end with HyFuse** — 80 tools discovered,
...
## The tool surface — 80 tools at a glance
...
(80-tool registry pin, handler parity, slot maps, craft resolution, queue,
